...
df2 = select_data_category(df,'branded_food_category')
#apply remove_char function
df2['ingredients'] = df2['ingredients'].apply(remove_char)

#create list for all ingredients
all_ingredients = [] 
for row in df2['ingredients']:
...
print(f"CATEGORY TOP INGREDIENTS \n{count[:10]}")
